        ...
        <div className="grid w-full grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
          ...
          <div>
            ...
            <Footer.LinkGroup col>
              ...
              <Footer.Link href="https://twitter.com" icon={BsTwitter}>Twitter</Footer.Link>
              <Footer.Link href="https://facebook.com" icon={BsFacebook}>Facebook</Footer.Link>
              <Footer.Link href="https://whatsapp.com" icon={BsWhatsapp}>WhatsApp</Footer.Link>
